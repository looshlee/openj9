...
class TR_PersistentCHTable
   ...
   virtual bool hasThreeOrMoreCompiledImplementers(TR_OpaqueClassBlock *, int32_t, TR_ResolvedMethod *, TR::Compilation *, TR_Hotness hotness = warm, bool locked = false);
   ...
   virtual void methodGotOverridden(TR_FrontEnd *, TR_PersistentMemory *, TR_OpaqueMethodBlock *overridingMethod, TR_OpaqueMethodBlock *overriddenMethod, int32_t smpFlag);
